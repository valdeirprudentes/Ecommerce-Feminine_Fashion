<!DOCTYPE HTML>
 ...
 -->
    ...
    <body>
        ...
        $consulta_usuario = $cn->query("select nm_livro, vl_preco, ds_capa, qt_estoque from vw_livro where ds_categoria = '$cat'");

        ?>

        <div class="container-fluid">
            <div class="row">
                <?php while ($exibe = $consulta_usuario->fetch(PDO::FETCH_ASSOC)) { ?>
                    <div class="col-sm-3">
            ...
            <!--Fechamento da classe row-->
        </div>
        <!--Fechamento do container fluid-->
